...
int main(int argc, char **argv) {
  ...
  for(i=-10; i<=100000; i++) {
    //is this && or what. is numKaprekarNumbers static at 24, so 24 would counted as kaprekar 
...
//I dont understand the function of this else, only false "isKaprekar" values are shown in this block
       else {
